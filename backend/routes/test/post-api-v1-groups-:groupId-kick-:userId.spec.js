...
const apiPath = '/api/v1/groups/:groupId/kick/:userId';
...
describe(apiPath, () => {
  ...
  it('should throw when user wants to kick another user from a group he created but has no permission for it', async () => {
    let thrownError;
  ...
  it('should throw when user wants to kick another user from a group he created but the group is not in the DB',
      async () => {
        let thrownError;
        ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
  ...
  it('should throw when user wants to kick another user from a group he is not part of #1',
      async () => {
        let thrownError;
        ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
  ...
  it('should throw when user wants to kick another user from a group he is not part of #2',
      async () => {
        let thrownError;
        ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
  ...
  it('should throw when user A wants to kick user B from a group but user B is not invited in the group',
      async () => {
        let thrownError;
        ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
  ...
  it('should throw when user A wants to kick user B from a group but user B is already kicked from the group', async () => {
    let thrownError;
    ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
  ...
  it('should update invitation when user A wants to kick user B from a group and user A has all permissions', async () => {
    ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
    ...
    expect(InvitationsUpdate.calledOnce).to.be.an.true;
  });

  it('should return invitation for user B when user A wants to kick user B from a group and user A has all permissions',
      async () => {
        ctx.state.userPermissions = ['canKickOthersFromOwnGroups'];
        ...
        expect(JSON.stringify( ctx.body )).to.equal('{"id":2,"status":"kicked"}');
      }
  );
});
